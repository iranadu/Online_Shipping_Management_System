...
public class viewEmployee extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("WebContent\\pages\\Emp_view.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		IEmp.viewEmployee(Employee1.Emp_id);
		
		request.setAttribute("Employee1", Employee1);

		RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("WebContent\\pages\\Employee.jsp");
		dispatcher.forward(request, response);
	}
	}
